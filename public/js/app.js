...
function carrusel() {
  ...
  setInterval(function () {
    ...
    $('.carrusel__img').animate({
      opacity: 0,
      transition: '.4s'
    });
    $('.carrusel__img').attr('src', "images/carrusel/image".concat(count, ".jpg"));
    $('.carrusel__img').animate({
      opacity: 1,
      transition: '.4s'
    });
...
__webpack_require__(/*! C:\Users\oliva\Documents\LaravelProjects\MovieSearch\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\oliva\Documents\LaravelProjects\MovieSearch\resources\sass\app.scss */"./resources/sass/app.scss");
